...
(define (problem p095-microban-sequential)
  ...
  (:init
    ...
    (located player-01 pos-2-2)
    (located stone-01 pos-4-3)
    (located stone-02 pos-5-3)
    (located stone-03 pos-3-4)
    (located stone-04 pos-6-4)
    (located stone-05 pos-3-5)
    (located stone-06 pos-6-5)
    (located stone-07 pos-4-6)
    (located stone-08 pos-5-6)
    (clear pos-2-3)
    (clear pos-2-4)
    (clear pos-2-5)
    (clear pos-2-6)

...
(define (problem p078-microban-sequential)
  ...
  (:init
    ...
    (located player-01 pos-03-06)
    (located stone-01 pos-04-03)
    (located stone-02 pos-06-03)
    (located stone-03 pos-03-04)
    (located stone-04 pos-05-04)
    (located stone-05 pos-07-04)
    (clear pos-01-01)
    (clear pos-01-06)
    (clear pos-01-07)
    (clear pos-01-08)

...
(define (problem p107-microban-sequential)
  ...
  (:init
    ...
    (located player-01 pos-7-7)
    (located stone-01 pos-3-3)
    (located stone-02 pos-4-3)
    (located stone-03 pos-5-3)
    (located stone-04 pos-6-3)
    (located stone-05 pos-3-4)
    (located stone-06 pos-6-4)
    (located stone-07 pos-3-5)
    (located stone-08 pos-6-5)
    (located stone-09 pos-3-6)
    (located stone-10 pos-4-6)
    (located stone-11 pos-5-6)
    (at-goal stone-02)
    (at-goal stone-03)
    (at-goal stone-04)
    (at-goal stone-05)

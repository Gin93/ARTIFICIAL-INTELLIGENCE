...
(define (problem p133-microban-sequential)
  ...
  (:init
    ...
    (located player-01 pos-04-05)
    (located stone-01 pos-05-05)
    (located stone-02 pos-08-05)
    (located stone-03 pos-04-06)
    (located stone-04 pos-05-06)
    (located stone-05 pos-08-06)
    (clear pos-01-01)
    (clear pos-01-02)
    (clear pos-01-03)
    (clear pos-01-08)
